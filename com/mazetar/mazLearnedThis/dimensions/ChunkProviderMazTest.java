...
public class ChunkProviderMazTest implements IChunkProvider {
    
    private byte fillerBlock = (byte)Block.dirt.blockID;
    ...
    public ChunkProviderMazTest(World world, long seed,
                    ...
                    for (int l1 = 0; l1 < 8; ++l1) {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2) {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2) {
                                if ((d16 += d15) > 0.0D) {
                                    par3ArrayOfByte[j2 += short1] = fillerBlock;// Filler Block, like stone in surface dimension.
                                } else if (k1 * 8 + l1 < b2) {

...
import com.mazetar.mazLearnedThis.dimensions.gen.GenLayerMaz;
...
public class WorldChunkMangerMaz extends WorldChunkManager {
    ...
    protected WorldChunkMangerMaz() {
        this.myBiomeCache = new BiomeCache(this);
        this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
        this.myBiomesToSpawnIn.add(ModBiomes.darkBiome);
        this.myBiomesToSpawnIn.add(ModBiomes.mazBiome);
    }

    public WorldChunkMangerMaz(long seed, WorldType worldtype) {
        this();
        // i changed this to my GenLayerTutorial
        GenLayer[] agenlayer = GenLayerMaz.makeTheWorld(seed);
        this.myGenBiomes = agenlayer[0];
        this.myBiomeIndexLayer = agenlayer[1];
    }

    public WorldChunkMangerMaz(World world) {
    ...
    public BiomeGenBase[] getBiomesForGeneration(
        ...
        for (int i = 0; i < par4 * par5; ++i) {
            if (aint[i] >= 0) {
                ...
                par1ArrayOfBiomeGenBase[i] = ModBiomes.mazBiome;
            }
        }

...
public class WorldGenMinableMaz extends WorldGenerator {
    ...
    public WorldGenMinableMaz(int id, int target) {
        ...
        this(id, target, Block.stone.blockID);
    }

    public WorldGenMinableMaz(int id, int meta, int number, int target) {
        this(id, number, target);
        minableBlockMeta = meta;
    }

    public WorldGenMinableMaz(int id, int number, int target) {
        this.minableBlockId = id;
        this.numberOfBlocks = number;
        this.field_94523_c = target;
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3,
        ...
        for (int l = 0; l <= this.numberOfBlocks; ++l) {
            ...
            double d8 = d2 + (d3 - d2) * (double) l
                    / (double) this.numberOfBlocks;
            double d9 = par2Random.nextDouble() * (double) this.numberOfBlocks
                    / 16.0D;
